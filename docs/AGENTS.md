...
| `docs/design-principles.md` | The design principles this project commits to, and the rationale for the choices (framework-agnostic core, Tailwind + tokens, Base UI primitives) |
